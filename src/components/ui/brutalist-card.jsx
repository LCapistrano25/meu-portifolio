          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex gap-2">
              <button 
                ...
                className={`w-10 h-10 border-2 border-black rounded-lg flex items-center justify-center transition-all ${
                  onExternalClick
                    ? 'bg-[var(--primary)] hover:shadow-[4px_4px_0px_0px_#000000] cursor-pointer'
                    : 'bg-[#cccccc] cursor-not-allowed opacity-50'
                }`}
              >
              ...
              <button 
                ...
                className={`w-10 h-10 border-2 border-black rounded-lg flex items-center justify-center transition-all ${
                  onGithubClick
                    ? 'bg-[#333] hover:shadow-[4px_4px_0px_0px_#000000] cursor-pointer'
                    : 'bg-[#cccccc] cursor-not-allowed opacity-50'
                }`}
              >
